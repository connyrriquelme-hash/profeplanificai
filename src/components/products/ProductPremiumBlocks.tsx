...
const PRODUCT_LABEL_TRANSLATIONS: Record<string, string> = {
  ...
  fields: 'Campos',
  // Agregados: mismo problema que en DocumentEditor.tsx::formatFieldLabel
  // (ver ese archivo) -- campos de rúbricas/evaluaciones/tickets que
  // quedaban en inglés dentro de documentos generados en español.
  name: 'Nombre',
  weight: 'Ponderación',
  score: 'Puntaje',
  levels: 'Niveles',
