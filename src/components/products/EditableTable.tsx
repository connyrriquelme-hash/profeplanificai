                  ...
                  >
                    {editCell?.row === rowIndex && editCell?.col === colIndex ? (
                      <input
                        ...
                        autoFocus
                        className="w-full px-2 py-1 text-sm border border-[var(--primary)] rounded focus:outline-none focus:ring-2 focus:ring-[var(--primary)] focus:border-[var(--primary)] bg-white"
