...
('hab_parv_desarrollo_personal_social', 'Desarrollo Personal y Social',
 (SELECT id FROM asignaturas WHERE name = 'Desarrollo personal y social' LIMIT 1),
...
('hab_parv_comunicacion_integral', 'Comunicación Integral',
 (SELECT id FROM asignaturas WHERE name = 'Comunicación integral' LIMIT 1),
 'hab_parv_transversal',
...
('hab_parv_interaccion_entorno', 'Interacción y Comprensión del Entorno',
 (SELECT id FROM asignaturas WHERE name = 'Interacción y comprensión del entorno' LIMIT 1),
 'hab_parv_transversal',
...
('hab_len_lectura', 'Lectura',
 (SELECT id FROM asignaturas WHERE name = 'Lenguaje y Comunicación' LIMIT 1),
...
('hab_mat_resolver_problemas', 'Resolver problemas',
 (SELECT id FROM asignaturas WHERE name = 'Matemática' LIMIT 1),
...
('hab_cie_observar_preguntar', 'Observar y plantear preguntas',
 (SELECT id FROM asignaturas WHERE name = 'Ciencias Naturales' LIMIT 1),
...
('hab_his_pensamiento_temporal_espacial', 'Pensamiento temporal y espacial',
 (SELECT id FROM asignaturas WHERE name = 'Historia, Geografía y Ciencias Sociales' LIMIT 1),
