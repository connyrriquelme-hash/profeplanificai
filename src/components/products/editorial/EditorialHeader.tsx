    ...
    >
      ...
      <div className="bg-[var(--primary)] px-4 md:px-6 py-2 flex items-center justify-between print:bg-[var(--primary)]">
        ...
        <div className="flex items-center gap-3">
          {version && (
            <span className="text-[#FFF6ED]/80 text-xs">v{version}</span>
          )}
          {pageNumber !== undefined && (
            <span className="text-[#FFF6ED]/80 text-xs">Página {pageNumber}</span>
          )}
        </div>
      </div>
          ...
          <div className="mt-3 pt-3 border-t border-gray-100 space-y-2">
            {oaCode && (
              <div className="flex items-start gap-2">
                <span className="px-2 py-0.5 text-xs font-mono font-bold bg-[var(--primary-tint)] text-[var(--primary-ink)] rounded border border-[var(--border)] flex-shrink-0">
                  {oaCode}
                </span>
                {oaText && (
