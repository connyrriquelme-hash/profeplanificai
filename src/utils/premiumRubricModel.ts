...
function buildCienciasCriteria(keywords: string[], _oaText: string, mainConcept: string): CriteriaTemplate[] {
  ...
  const base: CriteriaTemplate[] = [
    ...
    },
    {
      ...
      description: `Utiliza términos científicos appropriate para explicar ${mainConcept}`,
      descriptors: {
        avanzado: {
  ...
  return [
    ...
    },
    {
      ...
      descriptors: {
        ...
        inicial: { text: 'Sus expresiones son aisladas y necesitan apoyo para mantener coherencia', evidence: 'Oraciones simples con apoyo del docente', feedback: 'Vamos a连接 tus ideas: ¿Qué pasó primero? ¿Y después?' },
      },
    },
  ];
}
  ...
  return [
    {
      ...
      description: `Explora diverse materiales y técnicas artísticas para expresar ${mainConcept}`,
      descriptors: {
