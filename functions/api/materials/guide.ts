...
interface Env { DB: D1Database; AI?: ImageEnv['AI']; GEMINI_API_KEY?: string; JWT_SECRET: string; ENABLE_IMAGE_AI?: string; IMAGE_PROVIDER_ORDER?: string; HF_API_TOKEN?: string; IMAGE_CACHE_TTL_DAYS?: string }
