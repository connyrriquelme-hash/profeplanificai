...
function formatFieldLabel(key: string): string {
  const map: Record<string, string> = {
    ...
    fields: 'Campos',
    // Agregados: quedaban en inglés dentro de documentos generados en
    // español (Rúbrica Premium, Evaluación, Ticket de Salida, etc.) --
    // htmlFromValue() llama formatFieldLabel() para CADA clave que
    // encuentra, sin excepción, así que cualquier campo no listado aquí
    // se mostraba literal ("Levels", "Criteria", "Name:", "Weight:"...)
    // pese a que el contenido alrededor sí estaba en español.
    name: 'Nombre',
    weight: 'Ponderación',
    score: 'Puntaje',
    levels: 'Niveles',
    ...
    closure: 'Cierre',
    levelId: 'Nivel',
    feedbackSuggestion: 'Sugerencia de retroalimentación',
    totalScore: 'Puntaje total',
    totalPoints: 'Puntaje total',
    scoringFormula: 'Fórmula de puntaje',
    usageInstructions: 'Instrucciones de uso',
    inclusiveAdjustments: 'Adecuaciones inclusivas',
    formativeFeedbackQuestions: 'Preguntas de retroalimentación',
    studentSelfAssessment: 'Autoevaluación del estudiante',
    learningGoal: 'Meta de aprendizaje',
    studentFriendlyGoal: 'Meta para el estudiante',
    responseOptions: 'Opciones de respuesta',
    summaryRow: 'Resumen',
    feedbackRequired: 'Retroalimentación requerida',
