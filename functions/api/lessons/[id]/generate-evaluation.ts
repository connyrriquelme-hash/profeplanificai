...
export async function onRequestPost(context: EventContext<Env>): Promise<Response> {
  ...
  if (bundle.curriculum?.objective_id) {
    ...
    curriculumContext = {
      ...
      objective: { id: '', code: 'OA pendiente', official_text: `Evaluacion curricular para ${courseName}. El OA debe ser revisado y ajustado por el docente.`, normalized_text: '' },
  ...
  const localContent = buildLocalGeneration('evaluation', action, curriculumContext, bundle.lesson, bundle.plan || {});
