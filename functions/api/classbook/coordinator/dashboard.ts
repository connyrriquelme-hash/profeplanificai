...
export async function onRequestGet(context: EventContext<Env>): Promise<Response> {
  try {
    ...
    const filters = {
      ...
      termId: context.query.term_id as string | undefined,
      ...
      status: context.query.status as string | undefined,
      dateFrom: context.query.date_from as string | undefined,
      dateTo: context.query.date_to as string | undefined,
    };

    const data = await service.getDashboardSummary(institutionId, authContext, filters);
