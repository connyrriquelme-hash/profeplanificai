-- Migration 019: Shared documents & collaboration schema
-- D1 database: planificaia-db
--
-- Renombrada desde migrations.disabled-local/003_shared_docs.sql (nunca
-- aplicada -- el número 003 colisionaba con 003_images.sql, ya aplicada).
-- functions/api/data/shared-documents.ts y src/services/sharedDocumentService.ts
-- ya asumían que estas tablas existían; sin ellas, "Compartir" generaba un
-- link que solo funcionaba en el mismo navegador (el POST de sincronización
-- a la nube fallaba en silencio).
