...
function fixEncoding(s: string): string {
  ...
  t = t.replace(/(\d)ï¿½/g, '$1°');
  t = t.replace(/(\d)�/g, '$1°');
  t = t.replace(/Bï¿½sico/g, 'Básico');
  t = t.replace(/B�sico/g, 'Básico');
  t = t.replace(/Básico/g, 'Básico');
  t = t.replace(/Matem�tica/g, 'Matemática');
  t = t.replace(/Matemï¿½tica/g, 'Matemática');
  t = t.replace(/Lengua y Literatura/g, 'Lengua y Literatura');
  t = t.replace(/Historia/g, 'Historia');
  t = t.replace(/Ciencias/g, 'Ciencias');
  t = t.replace(/Ã¡/g, 'á');
  t = t.replace(/Ã©/g, 'é');
  t = t.replace(/Ã­/g, 'í');
  t = t.replace(/Ã³/g, 'ó');
