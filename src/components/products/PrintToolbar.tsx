...
export function PrintToolbar({ onPrint, onReset, className, style }: PrintToolbarProps) {
  return (
    <div 
      className={`print-toolbar flex flex-wrap items-center gap-3 p-4 bg-gray-50 rounded-lg border border-[var(--border)] print:hidden ${className || ''}`} 
      style={style}
      role="toolbar"
    ...
    >
      <button
        type="button"
        onClick={onPrint}
        className="inline-flex items-center gap-2 px-4 py-2 bg-[var(--primary)] text-white text-sm font-medium rounded-lg hover:bg-[var(--primary-ink)] focus:ring-2 focus:ring-[var(--primary)] focus:ring-offset-2 transition-colors"
      ...
      <button
        type="button"
        onClick={onReset}
        className="inline-flex items-center gap-2 px-4 py-2 bg-gray-100 text-[var(--ink)] text-sm font-medium rounded-lg hover:bg-gray-200 focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-colors"
